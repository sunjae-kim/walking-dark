...
import { RouteMap, ROUTE_NAMES } from '@/router/types'
...
export const useAppRouter = () => {
  ...
  const push = <N extends ROUTE_NAMES>(params: TypedRouteLocationRaw<N> | string) => {
    return router.push(params)
  }
  const replace = <N extends ROUTE_NAMES>(params: TypedRouteLocationRaw<N> | string) => {
    return router.replace(params)
  }

  const resolve = <N extends ROUTE_NAMES>(params: TypedRouteLocationRaw<N> | string) => {
